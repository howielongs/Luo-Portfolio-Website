      ...
      <Container>
        ...
        <VerticalTimeline>
          ...
          >
            ...
            <p> 
              - Accepted into the Bronco Venture Accelerator (BVA) program
            </p>
          </VerticalTimelineElement>
        ...
        <VerticalTimelineElement
            ...
            icon={<FaCode />}
          >
            <h3 className="vertical-timeline-element-title">Version Control Certification</h3>
            <h4 className="vertical-timeline-element-subtitle">META</h4>
            <p>
              - Gained a solid foundation in Git and GitHub, focusing on command line basics, repository management, and code revisions
            </p>
            <Image 
              src={versionControl} 
...
metrics to forecast player performance
            </p>
            <p> 
